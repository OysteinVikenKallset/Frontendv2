...
export default function Home() {
  ...
  return (
    ...
    <div className="margin-auto flex justify-center w-max">
      
      <div className='flex flex-col justify-between w-full p-4 m-4 text-center rounded-3xl bg-amber-200 text-black lg: max-w-md lg:w-fit'>
