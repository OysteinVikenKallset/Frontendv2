...
export default function Home() {
  ...
  return (
    ...
    <div className="margin-auto flex justify-center w-full flex-col">
    <h2 className="text-center">Hosting</h2>
      <div className='flex flex-col justify-between w-full p-4 m-4 text-center rounded-3xl bg-amber-200 text-black'>
