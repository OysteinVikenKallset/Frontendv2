    ...
    return (
        <div>
            ...
            <div className="flex flex-col justify-center text-center pt-5 pb-5 lg:flex-row">
                ...
                />
                <button className='flex w-full text-center align-center flex-center justify-center flex-col' onClick={setToCurrentTime}>Sett til nåværende tidspunkt</button>
            </div>
            <Task />
        </div>
    );
