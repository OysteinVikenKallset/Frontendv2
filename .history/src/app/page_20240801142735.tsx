...
export default function Home() {
  ...
  const fullstackBackendTechnologies = ['C#', '.net', 'Entity Framework', 'SQL lite'];
  ...
  return (
    ...
    <div>
      ...
      <div className='flex flex-col justify-between p-4 m-4 text-center rounded-3xl bg-amber-200 text-black w-full lg: max-w-md lg:w-fit'>
      <p><span className="font-semibold">Frontend: </span><Link href='https://vercel.com/'>vercel.com</Link></p>
      <p><span className="font-semibold">Backend: </span><Link href='https://azure.microsoft.com/'>azure.microsoft.com</Link></p>
      </div>
    </div>
    </div>
  );
