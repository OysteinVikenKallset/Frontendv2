...
export default function Home() {
  ...
  function Project(name: string, description: string, frontendTecknologies: Array<string>, BackendTecknologies: Array<string>) {
    this.name = name;
    this.description = description;
    this.frontendTecknologies = frontendTecknologies || [];
    this.BackendTecknologies = BackendTecknologies || [];
